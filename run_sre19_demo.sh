...
if [ $stage -le 10 ]; then
  ...
  python tools/cts_challenge_scoring_software/sre18_submission_scorer.py -o ${nnet_dir}/scores/sre18_dev_scores_nist -l /kongtl_tf/Data/SRE19/LDC2019E59/dev/docs/sre18_dev_trials.tsv -r /kongtl_tf/Data/SRE19/LDC2019E59/dev/docs/sre18_dev_trial_key.tsv
